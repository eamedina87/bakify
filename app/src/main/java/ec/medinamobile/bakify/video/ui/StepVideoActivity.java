...
public class StepVideoActivity extends AppCompatActivity implements StepVideoView, ExoPlayer.EventListener {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        videoFrame.showController();
        // If the event was not handled then see if the player view can handle it as a media key event.
        return super.dispatchKeyEvent(event) || videoFrame.dispatchMediaKeyEvent(event);
    }
    ...
    private void initializePlayer() {
        ...
        if (needNewPlayer) {
            ...
            @DefaultRenderersFactory.ExtensionRendererMode int extensionRendererMode =
                    ((BakifyApplication) getApplication()).useExtensionRenderers()
    ...
    private DataSource.Factory buildDataSourceFactory(boolean b) {
        ...
        return ((BakifyApplication) getApplication())
